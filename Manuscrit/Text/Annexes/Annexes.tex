...
\begin{table}[ht]
  ...
  \begin{tabular}[t]{ll}
    \toprule
    Full repartition & Reduced repartition \\ \midrule
    Rocks & Rocks \\    \midrule
    C, Grits & \multirow{2}{*}{Pebbles} \\
    CG, Grits and gravel & \\ \midrule
    G, Gravel & \multirow{3}{*}{Gravels} \\
    GC, Gravel and grits& \\
    GS, Sandy gravels & \\ \midrule
    S, Sands& \multirow{5}{*}{Sands} \\
    SC, Sands and grits& \\
    SG, Gravely sand& \\
    SGV, Gravely muddy sand& \\
    SV, Muddy sands& \\ \bottomrule
  \end{tabular}
  \begin{tabular}[t]{ll}\toprule
    Full repartition & Reduced repartition \\ \midrule
    SF, Fine sands & \multirow{2}{*}{Fine Sands} \\
    SFV, Fine and muddy sands& \\ \midrule
    Si, Silts & \multirow{1}{*}{Silts} \\ \midrule
    V, Muds & \multirow{4}{*}{Muds} \\
    VS, Sandy mud& \\
    VSF, Mud and fine sand& \\ \bottomrule
  \end{tabular}
}
...
is the value used for the observations.% . On
