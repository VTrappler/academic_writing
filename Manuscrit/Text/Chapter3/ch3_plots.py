...
plt.title(r'Integrated likelihood and mean objective')
plt.xlabel(r'$\theta$')
plt.ylabel(r'$J$')
plt.tight_layout()
plt.savefig('/home/victor/acadwriting/Manuscrit/Text/Chapter3/img/integrated_lik_average_costfunction.pgf')
plt.show()
...
plt.scatter(k[bh.argmin(0)][:-3], u[:-3], marker='.', color='white', label=r'$\min_\theta J(\theta, u)$', s=5)
plt.xlim([0, 1])
plt.ylim([0, 1])
plt.legend()
...
plt.tight_layout()
# plt.show()
plt.savefig('/home/victor/acadwriting/Manuscrit/Text/Chapter3/img/decision_under_uncertainty.pgf')
...
plt.xlabel(r'$\theta$')
plt.ylabel(r'$u$')
plt.title(u'Objective function')
ax = plt.subplot(1, 2, 2)
...
plt.tight_layout()
plt.savefig('/home/victor/acadwriting/Manuscrit/Text/Chapter3/img/mean_std_wc.pgf')
plt.show()
