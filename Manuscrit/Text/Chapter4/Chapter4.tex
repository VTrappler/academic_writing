...
\begin{figure}[ht]
  ...
  \caption{\label{fig:q_p_illu} Relation between the probability $\Gamma_{\alpha}$ and its maximum and the quantile function of the ratio}
\end{figure}
...
shown~\cref{fig:qPI_aIMSE}.\todo{refaire figures}
\begin{figure}[ht]
  \centering
