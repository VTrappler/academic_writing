...
\item If the covariance function $C_Z$ is known, the most expensive
  ...
  dimensions % \todo{ça s'adapte à des pbs de taille moyenne}
...
in~\cite{echard_ak-mcs_2011,schobi_rare_2017,razaaly_rare_2019,razaaly_extension_2020}.
The probability of coverage, defined using $\Delta_{\alpha}$ is
\begin{equation}
