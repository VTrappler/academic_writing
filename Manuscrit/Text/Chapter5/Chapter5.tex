...
~\Cref{fig:optim_croco_misspecified}
shows the resulting optimisation for $\uu^b=(0, 0) $ and for
$\uu^b=(1, 1)$. We can see that while the Bay of Biscay is
...
A comparison of the two methdos is summarised in~\cref{tab:results_croco}.
...
``nicely'' under uncertainties: there does not seem to be a lot of interactions
