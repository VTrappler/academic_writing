...
forcing: the environmental variable is set to
$\uu^{\mathrm{truth}}$. In ocean modelling, one of the easily
measurable quantity is the water free surface height
$\eta$.\todo{introduction $eta$}
...
\todo{commentaire sur la qualité des résultats dans le cas misspécifié}
\begin{figure}[ht]
  \centering
