...
Some improvements can be easily considered: if the gradient of the
objective function $J$ is available, the global optimisation step,
\emph{i.e.} the computation of the parameters of $\Delta_\alpha$ or
$\Xi$ can be sped up, or atleast can give a more precise estimation of
the conditional minimum $m_{Z^*}$ and minimisers $\kk^*_Z$.
