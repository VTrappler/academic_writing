...
On~\cref{fig:evo_alphap_kp} is shown the maximal probability reached
by $\hat{\Gamma}^{\mathrm{PI}}_{\alpha}$ as a function of $\alpha$,
and the different components of the control variable
...
\begin{figure}[ht]
  ...
  \caption{\label{fig:evo_alphap_kp} Evolution of the maximum reached
    by $\Gamma_{\alpha}$ when $\alpha$ increases, and associated
