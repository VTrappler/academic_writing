...
\begin{figure}[ht]
  ...
  \caption{\label{fig:sediments_reduced} Repartition of the sediments
    on the ocean floor. Data source: SHOM, under CC BY-SA-4.0
    license}
\end{figure}
%\footnotetext[2]{\url{https://creativecommons.org/licenses/by-sa/4.0/}}
...
$\hat{\kk}= \argmin_{\kk\in\Kspace} \hat{q}_p(\kk)$. With
$k=\Phi^{-1}(1 - 0.025)$ the quantile of order \num{0.975} of the
...
reduction method in order to get $K_q$ points for each margin, adjust
them and finally evaluate the $3\cdot K_q$ points by the objective
function.
                         %
