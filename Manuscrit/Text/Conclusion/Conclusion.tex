...
In this thesis, the random variables $J^*(\UU)$, and $\kk^*(\UU)$
which represent the conditional minimum and minimisers respectively,
play a central role in our notions of robustness. Those distributions
