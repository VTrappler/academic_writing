...
La définition de la fonction coût dans un problème de calibration sera abordé dans le Chapitre~\ref{chap:inverse_problem}.
...
$\uu$ supposée, et que pour une autre réalisation de la variable
aléatoire sous-jacente, le modèle ainsi calibré donne des prédictions
...
l'on prend en compte le caractère aléatoire de $\uu$.
