...
\usepackage{pgf}
\usepackage{tikz}
\usetikzlibrary{calc, fit, matrix, arrows, automata, positioning, shapes.arrows, fadings, patterns}
...
\newmdtheoremenv[style=theoremStyle]{envThm}[thmCounter]{Théorème}
\newmdtheoremenv[style=theoremStyle]{envDef}[thmCounter]{Définition}
\newmdtheoremenv[style=theoremStyle]{envConj}[thmCounter]{Conjecture}
\newmdtheoremenv[style=theoremStyle]{envLem}[thmCounter]{Lemme}
\newmdtheoremenv[style=theoremStyle]{envRem}[thmCounter]{Remarque}
\newmdtheoremenv[style=theoremStyle]{envEx}[thmCounter]{Example}
\newmdtheoremenv[style=theoremStyle]{envProp}[thmCounter]{Proposition}
\newmdtheoremenv[style=theoremStyle]{envCor}[thmCounter]{Corollaire}
...
\setcounter{minitocdepth}{3} % Si depth = 4 : paragraphes inclus; depth=3 : subsubsections incluses
