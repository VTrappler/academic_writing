...
\DeclareMathOperator*{\ProbGP}{\mathcal{P}}
...
\newcommand{\aciter}[1]{\todo[linecolor=violet,backgroundcolor=violet!25,bordercolor=violet, inline, inlinewidth=5cm, noinlinepar]{~ #1 ~}}
