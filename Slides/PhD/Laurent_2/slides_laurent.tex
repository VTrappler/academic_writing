...
\begin{frame}
  ...
  \resizebox{\textwidth}{!}{\input{\manupath Chapter5/img/distribution_minimizers.pgf}}
\end{frame}
\begin{frame}
    \renewcommand\rmfamily{\sffamily}
  \frametitle{Distribution of minimizers, with associated $J^*$}
  \resizebox{\textwidth}{\textheight}{\includegraphics{\manupath Chapter5/img/Jstar.pdf}}
\end{frame}

\begin{frame}
    \renewcommand\rmfamily{\sffamily}
  \frametitle{Distribution of minimizers: cluster analysis}
  \resizebox{\textwidth}{\textheight}{\includegraphics{\manupath Chapter5/img/cluster_pair.pdf}}
\end{frame}
% \begin{frame}
%     \renewcommand\rmfamily{\sffamily}
%   \frametitle{Distribution of minimizers}
%   \resizebox{\textwidth}{!}{\input{\manupath Chapter5/img/cluster_pair.pgf}}
% \end{frame}
\begin{frame}
  ...
  \begin{table}[!h]
    ...
    \begin{tabular}{rrrrrrr}\toprule
      ...
      % array(0.01081847), 't2': array(0.01320861), 't3': array(0.00405085), 't4': array(0.00951649), 'u1': array(0.56743005), 'u2': array(0.21216804)
      $\min \Ex$ & $11.002$ & $12.437$ & $4.765$ & $8.881$& & \\%t1': array(0.01078828), 't2': array(0.01339522), 't3': array(0.00337447), 't4': array(0.00459665), 'u1': array(0.59232212), 'u2': array(4.50044708e-38)}
      \bottomrule
    \end{tabular}
  \end{table}
\end{frame}
