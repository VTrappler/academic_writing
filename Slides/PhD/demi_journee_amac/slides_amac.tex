...
\frame{
  ...
  Minimization performed on $\kk\mapsto J\left(\kk,\uu^b\right)$, for different $\uu^b$:
  \vfill
  \only<2>{Well-specified model: $\uu^b=(0.5, 0.5)$}
  \only<3>{Misspecified model: $\uu^b=(0.0, 0.0)$}
  \only<4>{Misspecified model: $\uu^b=(0.0, 0.5)$}
  \only<5>{Misspecified model: $\uu^b=(0.0, 1.0)$}
  \only<6>{Misspecified model: $\uu^b=(0.5, 0.0)$}
  \only<7>{Misspecified model: $\uu^b=(0.5, 1.0)$}
  \only<8>{Misspecified model: $\uu^b=(1.0, 0.0)$}
  \only<9>{Misspecified model: $\uu^b=(1.0, 0.5)$}
  \only<10>{Misspecified model: $\uu^b=(1.0, 1.0)$}
  ...
  \begin{center}
    ...
    \includegraphics<1>[width=.9\textwidth]{\manupath Chapter5/img/sediments_reduced.png}
    ...
    \includegraphics<2>[width=\textwidth]{/home/victor/optimisation_dahu/optim_sediments/map_lognorm_200.png}
    \includegraphics<3>[width=\textwidth]{/home/victor/optimisation_dahu/1b/map_lognorm_200.png}
    \includegraphics<4>[width=\textwidth]{/home/victor/optimisation_dahu/2b/map_lognorm_200.png}
    \includegraphics<5>[width=\textwidth]{/home/victor/optimisation_dahu/3b/map_lognorm_200.png}
    \includegraphics<6>[width=\textwidth]{/home/victor/optimisation_dahu/4b/map_lognorm_200.png}
    \includegraphics<7>[width=\textwidth]{/home/victor/optimisation_dahu/6b/map_lognorm_200.png}
    \includegraphics<8>[width=\textwidth]{/home/victor/optimisation_dahu/7b/map_lognorm_200.png}
    \includegraphics<9>[width=\textwidth]{/home/victor/optimisation_dahu/8b/map_lognorm_200.png}
    \includegraphics<10>[width=\textwidth]{/home/victor/optimisation_dahu/9b/map_lognorm_200.png}
  \end{center}
  \pnote{
...
\item \alert<2>{Best performance achievable given $\uu \sim \UU$, regret-based robustness}
\end{itemize}
}
...
\begin{frame}
  ...
  \begin{block}{Relative-regret family of estimators~\cite{trappler_robust_2020}}
  \begin{equation}
...
%     \begin{columns}
%       \begin{column}{.5\textwidth}
%   \includegraphics[width=\textwidth]{\manupath Chapter5/img/sediments_reduced.png}
% \end{column}
% \begin{column}{.5\textwidth}
